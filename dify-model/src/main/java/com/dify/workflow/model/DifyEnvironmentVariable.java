...
/**
 * Dify environment variable definition.
 */
public final class DifyEnvironmentVariable {
    @JSONField(name = "id")
    ...
    public DifyEnvironmentVariable(String id, String name, String value, String valueType,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DifyEnvironmentVariable)) return false;
        DifyEnvironmentVariable that = (DifyEnvironmentVariable) o;
    ...
    public String toString() {
        return String.format("DifyEnvironmentVariable[id=%s, name=%s, value=%s, valueType=%s, description=%s, selector=%s]",
